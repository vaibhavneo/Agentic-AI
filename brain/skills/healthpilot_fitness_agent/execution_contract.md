# Execution contract — healthpilot_fitness_agent v1.0.0
...
1. **ROUTE TO SPECIALIST** — the adapter maps this skill's id
   (`healthpilot_fitness_agent`) to HealthPilot's own internal specialist key
   (`fitness_agent`, from `agents/specialists.py::SPECIALISTS`) and sends
...
This skill answers as the **Fitness Agent** specialist specifically.
