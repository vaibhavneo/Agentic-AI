# Execution contract — healthpilot_general_coach v1.0.0
...
1. **ROUTE TO SPECIALIST** — the adapter maps this skill's id
   (`healthpilot_general_coach`) to HealthPilot's own internal specialist key
   (`general`, from `agents/specialists.py::SPECIALISTS`) and sends
...
This skill answers as the **General Health Coach** specialist specifically.
