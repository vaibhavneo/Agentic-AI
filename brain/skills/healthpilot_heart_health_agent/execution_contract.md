# Execution contract — healthpilot_heart_health_agent v1.0.0
...
1. **ROUTE TO SPECIALIST** — the adapter maps this skill's id
   (`healthpilot_heart_health_agent`) to HealthPilot's own internal specialist key
   (`heart_health_agent`, from `agents/specialists.py::SPECIALISTS`) and sends
...
This skill answers as the **Heart-Health Nutrition Agent** specialist specifically.
