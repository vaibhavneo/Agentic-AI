# Execution contract — healthpilot_nutrition_planner v1.0.0
...
1. **ROUTE TO SPECIALIST** — the adapter maps this skill's id
   (`healthpilot_nutrition_planner`) to HealthPilot's own internal specialist key
   (`nutrition_planner`, from `agents/specialists.py::SPECIALISTS`) and sends
...
This skill answers as the **Nutrition Planner** specialist specifically.
