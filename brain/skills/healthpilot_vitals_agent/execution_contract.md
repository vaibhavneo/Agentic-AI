# Execution contract — healthpilot_vitals_agent v1.0.0
...
1. **ROUTE TO SPECIALIST** — the adapter maps this skill's id
   (`healthpilot_vitals_agent`) to HealthPilot's own internal specialist key
   (`vitals_agent`, from `agents/specialists.py::SPECIALISTS`) and sends
...
This skill answers as the **Vitals Agent** specialist specifically.
