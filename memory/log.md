...
- 2026-07-11 C27.1 Central Orchestrator design (Part 4, all H-O1-6 approved) + WP-O0/WP-O1: spike found brain/stock_agent/health-agent/vedic_astro all collide on bare `agents` (+brain/health-agent on `tools`); resolved per-app via H-O2 escape hatch -- brain+feynman_agent in-process, other 3 over HTTP to their live servers; orchestrator/apps.json drafted; D20
