...
def run_vectorized_backtest(
    ...
    Point-in-time correctness is enforced HERE, once:
      ...
      cost[t]               charged only on days the position actually changes
    """
...
def deflated_sharpe_ratio(
    ...
    tried for this ticker (from strategies.py's registry), NOT the count of
    LLM agents — the multiple-comparisons problem this metric guards against
    is at the parameter/strategy level.
    """
    if n_obs < 2:
        return 0.0
