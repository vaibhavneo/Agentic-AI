...
def _run_one(name, fn, df, prices, n_trials):
    ...
    return m, dsr, result.n_trades, current_signal, kelly
...
def main():
    ...
    if only_strategy:
        ...
        n_trials = len(STRATEGY_REGISTRY)   # comparing all 7 = 7 trials, for honest dSR deflation
    ...
    for name, fn in to_run.items():
        try:
            m, dsr, n_trades, current_signal, kelly = _run_one(name, fn, df, prices, n_trials)
