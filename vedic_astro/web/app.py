...
def _chat_with_client(client, system: str, messages: list, max_tokens: int = 1500) -> str:
...
if __name__ == "__main__":
    ...
    print(f"   LLM: {'DeepSeek deepseek-chat' if provider == 'deepseek' else 'Anthropic claude-sonnet-4-6' if provider == 'anthropic' else 'NOT SET'}")
